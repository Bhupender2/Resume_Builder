...
const CodeH = () => {
    ...
    return <div className="min-h-screen w-11/12 text-gray-700 font-semibold flex flex-col p-2 m-4 shadow-lg">
        ...
        <div className="w-full h-auto mb-4 flex flex-col">
            <div className="pl-2 text-xl font-extrabold bg-yellow-200">Professional Summary</div>
            <div className="">{personalDetails.ProfSum}</div>
        </div>
        <div className="w-full h-auto flex flex-col">
            <div className=" text-xl font-extrabold bg-yellow-200 pl-2">Skills</div>
        ...
        <div className="w-full h-auto mb-4 flex flex-col">
            <div className="pl-2 text-xl font-extrabold bg-yellow-200">Education</div>
            <div className="flex flex-col h-full w-10/12 my-0 mx-auto">
                <div className="h-full w-full mt-2">
                    <div className="h-full w-full flex justify-between">
                        ...
                        <div className="italic text-bold text-md text-yellow-400">{Education.Year}</div>
                    </div>
                ...
                <div className="h-full w-full mt-2">
                    <div className="h-full w-full flex justify-between">
                        ...
                        <div className="italic text-bold text-md text-yellow-400">{Education.Sname12Year}</div>
                    </div>
                ...
                <div className="h-full w-full mt-2">
                    <div className="h-full w-full flex justify-between">
                        ...
                        <div className="italic text-bold text-md text-yellow-400">{Education.Sname10Year}</div>
                    </div>
        ...
        <div className="w-full h-auto mb-4 flex flex-col">
            <div className=" text-xl font-extrabold pl-2 bg-yellow-200">Projects</div>
            <div className="flex flex-col h-full w-10/12 my-0 mx-auto">
                {
        ...
        <div className="w-full h-auto flex flex-col">
            <div className=" text-xl font-extrabold pl-2 bg-yellow-200">Achievements</div>
