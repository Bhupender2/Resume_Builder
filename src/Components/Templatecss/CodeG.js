...
const CodeG=()=>{
    ...
    return <div className="min-h-screen w-11/12 text-gray-500            font-semibold flex flex-col p-2 m-4 shadow-lg">
            ...
            <div className="w-full max-h-72 mb-4 flex">
                <div className="h-full w-3/12  pt-2 pr-2 text-green-500">Professional Summary</div>
                <div className="flex flex-col h-full w-9/12 mb-0 ">{personalDetails.ProfSum}</div>
            </div>
            <div className="w-full h-auto flex">
                <div className="h-full w-3/12 text-green-500">Skills</div>
            ...
            <div className="w-full max-h-72 mb-4 flex">
                <div className="h-full w-3/12 pt-2 text-green-500">Education</div>
                <div className="flex flex-col h-full w-9/12 mb-0">
                    <div className="h-full w-full mt-2">
                    <h5 className="tracking-widest leading-tight mb-0 text-green-400">{Education.CollegeName}</h5>
                    ...
                    <div className="h-full w-full mt-2">
                    <h5 className="tracking-widest leading-tight mb-0 text-green-400">{Education.Sname12}</h5>
                    ...
                    <div className="h-full w-full mt-2">
                    <h5 className="tracking-widest leading-tight mb-0 text-green-400">{Education.Sname10}</h5>
            ...
            <div className="w-full h-auto mb-4 flex">
                <div className="h-full w-3/12 text-green-500 ">Projects</div>
                <div className="flex flex-col h-full w-9/12 mb-0">
                    {
                        Projects.map(myprojects=>{
                            return <div className="h-auto w-full mt-2">
                                    <div className="tracking-widest leading-tight mb-0 text-green-400">&#x2713;{myprojects.Title}</div>
            ...
            <div className="w-full h-auto flex">
                <div className="h-full w-3/12 pt-2 text-green-500">Achievements</div>
