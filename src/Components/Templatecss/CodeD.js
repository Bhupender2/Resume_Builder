...
const CodeD=()=>{
    ...
    return <div className="min-h-screen w-11/12 text-gray-500            font-semibold flex flex-col p-2 m-4 shadow-lg">
            ...
            <div className="w-full max-h-72 mb-4 flex bg-pink-100 p-1">
            {personalDetails.ProfSum}</div>
            <div className="w-full h-auto flex">
                <div className="h-full w-3/12 text-pink-300">Skills</div>
            ...
            <div className="w-full max-h-72 mb-4 flex">
                <div className="h-full w-3/12 pt-2 text-pink-300">Education</div>
            ...
            <div className="w-full h-auto mb-4 flex">
                <div className="h-full w-3/12 text-pink-300 ">Projects</div>
                <div className="flex flex-col h-full w-9/12 mb-0">
                    {
            ...
            <div className="w-full h-auto flex">
                <div className="h-full w-3/12 pt-2 text-pink-300">Achievements</div>
